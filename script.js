...
════════════════════════════════════════════════ */
const MEMORIES = [
  { src: 'received_1014955546435957.jpeg', emoji: '🌸', caption: 'จากตอนนั้นถึงตอนนี้ ก็ยังน่ารักไม่เปลี่ยนเลยนะ', date: 'คนแรก' },
  { src: '1702036617735.jpg', emoji: '☕', caption: 'กี่ปีผ่านไป ก็ยังน่ารักไม่เปลี่ยนเนอะ', date: 'ช่วงเวลาดีๆ' },
  { src: 'received_1561511214678022.jpeg', emoji: '🌙', caption: 'เปิดตัวครั้งแรกแอบเกร็งอยู่นะ', date: 'ครั้งแรก' },
  { src: '1709034176086.jpeg', emoji: '✨', caption: 'รวบรวมความกล้าในการให้ครั้งแรก', date: 'วันพิเศษ' },
  { src: 'S__12804123.jpg', emoji: '✨', caption: 'ครั้งที่สองเลยตามมา', date: 'วันพิเศษ' },
  { src: 'IMG_0688(1).JPG', emoji: '✨', caption: 'ครั้งที่สามก็ไม่ควรหายไป', date: 'วันพิเศษ' },
  { src: 'artworks-gTiCU1kjIJY4Eg5N-3wyzzg-t500x500.jpg', emoji: '🎶', caption: 'เพลงที่ทำให้นึกถึงกันทุกครั้งที่ได้ยิน', date: 'เพลงของเรา', isSong: true },
  { src: 'S__12804126.jpg', emoji: '🍜', caption: 'มื้อที่กินด้วยกัน อร่อยกว่าทุกมื้อเสมอ', date: 'มื้อพิเศษ' },
  { src: 'original 2567-12-29 112952.062.JPG', emoji: '🎠', caption: 'สถานที่ที่เราไปด้วยกัน แล้วอยากกลับไปอีก', date: 'สถานที่ของเรา' },
  { src: 'S__12804118.jpg', emoji: '🌅', caption: 'ช่วงเวลายามเย็นที่อบอุ่นที่สุด', date: 'ยามเย็น' },
  { src: 'S__12804120.jpg', emoji: '❤️', caption: 'อยากให้ช่วงเวลาแบบนี้อยู่กับเราไปนานๆเนอะ', date: 'อบอุ่น' },
  { src: 'S__12804130.jpg', emoji: '❤️', caption: 'ที่จริงตอนนั้นมันก็ดีนะ', date: 'อบอุ่น' },
  { src: 'S__12804114.jpg', emoji: '❤️', caption: 'ผ่านอะไรมาด้วยกันเยอะนะ', date: 'อบอุ่น' },
  { src: 'S__12804112.jpg', emoji: '❤️', caption: 'บางทีก็เคยคิดว่าพยายามอยู่ฝ่ายเดียวรึป่าว', date: 'อบอุ่น' },
  { src: 'S__12804105.jpg', emoji: '❤️', caption: 'แต่ขอให้มันเป็นแบบนี้ต่อไปได้มั้ย', date: 'อบอุ่น' },
  { src: 'S__12804124.jpg', emoji: '❤️', caption: 'ขอบคุณเท็นที่เข้านะ', date: 'อบอุ่น' },
  { src: 'S__12804129.jpg', emoji: '❤️', caption: 'เราขอที่จะรักเท็นไปตลอดได้มั้ย', date: 'อบอุ่น' },
  { src: 'S__12804115.jpg', emoji: '❤️', caption: 'รักนะครับ', date: '27/02/2026' },
];
...
function initProposePage() {
  ...
  document.getElementById('propose-subtitle').textContent = `รู้ใช่มั้ยว่าเรารักเท็นมากแค่ไหนที่ผ่านมาเรารู้สึกกับเท็นยังไงเราพยายามเพื่อเท็นมากแค่ไหน\nกลับมาครั้งนี้เรามาทำมันให้ดีขึ้นกันนะ\n\nเราขออยู่ดูแลเองไปตลอดเลยได้มั้ย`;
